...
### Energy
- **prism-energy** (v1.5.0) – Energy flow card with flowing beam particles, color themes, glassmorphism pills, SOC-aware battery/EV icons with red→green gradient, rich weather effects (glowy sun, rain, snow, hail, wind, fog, storms, clouds) with manual override, 10 generic entity-driven overlays, two extra pills, and 8 custom pills with tap actions
