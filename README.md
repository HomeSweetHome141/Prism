...
### Energy
- **prism-energy** (v1.5.3) – Energy flow card with flowing beam particles, color themes, glassmorphism pills, SOC-aware battery/EV icons with red→green gradient, rich weather effects (dynamic sun path with dawn/day/dusk colors, manual sun phase override, house-facing rays, rain, snow, hail, wind, fog, storms, clouds) with manual override, 10 generic entity-driven overlays, polished cloud/night/snow visuals, two extra pills, and 8 custom pills with tap actions
