...
### Energy
- **prism-energy** (v1.4.2) – Energy flow card with flowing beam particles, color themes, glassmorphism pills, SOC arc rings, rich weather effects (sun, rain, snow, hail, wind, fog, storms, clouds) with manual override, overlays, two extra pills, and 8 custom pills with tap actions
